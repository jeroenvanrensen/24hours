<div x-data="{ showDropup: false, showModal: false }">
    <x-heading>
        ...
        <!-- Edit button -->
        @can('edit', $board)
            <a title="Edit this board" href="{{ route('boards.edit', $board) }}" class="block ml-6 -mr-4 p-2 bg-gray-200 hover:bg-gray-300 focus:bg-gray-300 focus:outline-none rounded-full">
        ...
        <a title="View members" href="{{ route('members.index', $board) }}" class="block ml-6 p-2 bg-gray-200 hover:bg-gray-300 focus:bg-gray-300 focus:outline-none rounded-full">
            <svg class="w-4 h-4 text-gray-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
