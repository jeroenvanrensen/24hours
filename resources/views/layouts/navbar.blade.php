<nav class="py-4 px-6 md:px-12 flex items-center justify-between">
    ...
    @auth
        <a href="{{ route('profile.edit') }}" class="p-2 rounded-full bg-gray-100 hover:bg-gray-300 focus:outline-none focus:bg-gray-300 text-gray-600 dark:bg-gray-700 dark:hover:bg-gray-500 dark:focus:bg-gray-500 dark:text-gray-200">
