<nav class="py-4 px-12 flex items-center justify-between">
    ...
    <ul class="flex">
        <li>
            <a href="{{ route('boards.index') }}" class="flex items-center font-semibold py-2 px-4 rounded-full {{ url()->current() == route('boards.index') ? 'bg-blue-100 text-blue-600' : 'hover:text-blue-600' }}">
