...
>
    <div class="relative">
        ...
        <input
            ...
            wire:model="query"
            type="text"
            class="w-full px-4 py-2 text-gray-200 placeholder-gray-300 bg-gray-600 rounded-md cursor-pointer dark:bg-gray-700 focus:cursor-text hover:bg-gray-500 pl-11 focus:text-black dark:focus:text-gray-200 dark:focus:placeholder-gray-300 dark:focus:bg-gray-700 focus:bg-white focus:placeholder-gray-500"
            placeholder="Search..."
            @focusin="focus = true"
        ...
        <div class="absolute top-0 flex items-center h-10 text-gray-300 pointer-events-none right-4" :class="{ 'text-gray-300': !focus, 'text-gray-400 dark:text-gray-300': focus }">
    ...
    >
        ...
        @empty
        <p class="px-4 py-2 text-gray-500 pointer-events-none dark:text-gray-400">{{ empty($query) ? 'Start typing...' : 'No results found.' }}</p>
        @endforelse
    </div>
</div>
